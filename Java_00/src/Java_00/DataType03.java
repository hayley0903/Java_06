...
public class DataType03 {
	 ...
	 */
		...
		float strflt2 = 0.5f;
		System.out.println("String flt1 =" + strflt1);
		System.out.println("flt2 =" + strflt2);
		System.out.println("String flt1 + flt2 =" + (strflt1+strflt2));
		
		System.out.println("String flt1 + flt2 =" + (str2+strflt2));
		
	
		
		
		//java String을 double로 변경
		String str3 = "3.0";
		Double.parseDouble(str3);
		System.out.println(str3);
		
		double strdb1 = Double.parseDouble(str3);
		double strdb2 = 5.67;
		
		System.out.println("String db1 =" + strdb1);
		System.out.println("db2 =" + strdb2);
		System.out.println("String flt1 + flt2 =" + (strdb1+strdb2));
