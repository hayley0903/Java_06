...
public class PhoneBookDAO {
	...
	public void insert(String name, String tel, String addr) {
		...
		// map.put(key, value);
		System.out.println("등록된 정보는" + phoneBookMap.get(name));
...
// 		HashMap put 활용
		...
		System.out.println("등록전 >>> " + phoneBookMap.get(name));
		
		phoneBookMap.put(name, phone);
		
		
		// map.put(key, value);
		System.out.println("등록후 >>>" + phoneBookMap.get(name));
	}
