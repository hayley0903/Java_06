...
public class ForYouServiceImpl implements ForYouService {
	...
	public void programStart() {
		...
		while(true) {
			...
			default:
				System.out.println("0, 1, 2 중 선택해주세요");
	...
	public void solutionBook() {
		...
		//		// 고민해결책의 답 가져오기
		//		
		//		List<String> solutionBook = forYouDAO.selectSolutionBook();
		// 
		...
		//		// 상세 로직 구현
		//		
		//		int ramdomIndex = (int)(Math.random()* solutionBook.size());
		//		String randomElement = solutionBook.get(ramdomIndex);
	...
	public void fortuneBook() {
		...
		//		// 고민해결책의 답 가져오기
		//		List<String> fortuneBook = forYouDAO.selectfortuneBook();
		//
		...
		//		// 상세 로직 구현
		//		
		//		int ramdomIndex = (int)(Math.random()* fortuneBook.size());
		//		String randomElement = fortuneBook.get(ramdomIndex);
		//		System.out.println(randomElement);
